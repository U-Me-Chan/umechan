...
final class UnsetPublicBoard extends Command
{
    ...
    {
        $this
            ->setName('boards:unset-public')
            ->setDescription('Делает раздел приватным')
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            $this->board_service->setPublicFlagState($input->getArgument('tag'), false);
