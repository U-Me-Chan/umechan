...
final class SetBlockedThread extends Command
{
    ...
    {
        $this
            ->setName('posts:set-blocked-thread')
            ->setDescription('Устанавливает флаг заблокированного к ответу треда')
    ...
    public function execute(InputInterface $input_interface, OutputInterface $output_interface)
    {
        ...
        try {
            $this->post_service->setBlockedFlagStateToThread($input_interface->getArgument('thread_id'), true);
