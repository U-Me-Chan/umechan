...
class DayRandomPatternRotation implements IRotation
{
    public const NAME = 'DayRandomPatternRotation';
    ...
    public function execute(): void
    {
        ...
        $track_paths       = $this->random_tracklist_generator->build(Day::getRandomPattern(), 10);
